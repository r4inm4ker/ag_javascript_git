...
const steps = [
    {
        ...
        desc: "Your wip branch has been pushed to the remote. A Merge Request compares the wip branch (source) against main (target), letting teammates review every commit before it is merged.",
...
btnNext.addEventListener('click', () => {
    ...
    if (currentStep === 1) {
        ...
        // Insert merge commit on top (newest), then the wip commit below it
...
btnReset.addEventListener('click', () => {
    ...
    mrActivity.innerHTML = `
        <div>&#x1F4E4; Pushed <code>wip</code> branch</div>
