(function () {
    ...
    const PAGES = [
        ...
        { num: 9,  file: 'rollback.html',       label: 'Git Rollback',           color: '#ef4444' },
        { num: 10, file: 'squash.html',         label: 'Git Squash',             color: '#a855f7' },
        { num: 11, file: 'cherry_pick.html',    label: 'Git Cherry-Pick',        color: '#06b6d4' },
        { num: 12, file: 'merge.html',          label: 'Git Merge',              color: '#8b5cf6' },
        { num: 13, file: 'rebase.html',         label: 'Git Rebase',             color: '#ec4899' },
        { num: 14, file: 'stash.html',          label: 'Git Stash',              color: '#f59e0b' },
        { num: 15, file: 'blame.html',          label: 'Git Blame',              color: '#6366f1' },
    ];
        ...
        <nav class="sidebar" id="sidebar" aria-label="Tutorial navigation">
            <div class="sidebar-header">
                <a href="index.html" class="sidebar-logo" title="Directory">
                    ...
                    <span class="sidebar-logo-text">Git Diagrams</span>
                </a>
