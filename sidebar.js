(function () {
    ...
    const PAGES = [
        ...
        { num: 5,  file: 'merge_conflict.html', label: 'Merge Conflict',         color: '#ef4444' },
        { num: 6,  file: 'branch.html',         label: 'Branch & Commits',       color: '#a855f7' },
        { num: 7,  file: 'push_branch.html',    label: 'Git Push Branch',        color: '#10b981' },
        { num: 8,  file: 'merge_request.html',  label: 'Merge Requests',         color: '#3b82f6' },
        { num: 9,  file: 'pull.html',           label: 'Git Pull',               color: '#f59e0b' },
