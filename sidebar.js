(function () {
    ...
    const PAGES = [
        ...
        { num: 2, file: 'commit_history.html', label: 'Commit History', color: '#60a5fa' },
        { num: 3, file: 'multi_file_commit.html', label: 'Multi-File Commits', color: '#10b981' },
        { num: 4, file: 'clone.html', label: 'Git Clone', color: '#f59e0b' },
        { num: 5, file: 'edit_commit.html', label: 'Git Add & Commit', color: '#60a5fa' },
        { num: 6, file: 'push.html', label: 'Git Push', color: '#10b981' },
        { num: 7, file: 'git_pull_main.html', label: 'Git Pull Fast-Forward', color: '#f59e0b' },
        { num: 8, file: 'pull.html', label: 'Git Pull (Merge)', color: '#f59e0b' },
        { num: 9, file: 'merge_conflict.html', label: 'Merge Conflict', color: '#ef4444' },
        { num: 10, file: 'branch.html', label: 'Branch & Commits', color: '#a855f7' },
        { num: 11, file: 'push_branch.html', label: 'Git Push Branch', color: '#10b981' },
        { num: 12, file: 'merge_request.html', label: 'Merge Request', color: '#3b82f6' },
        { num: 13, file: 'checkout_main_pull_origin_main.html', label: 'Git Checkout & Pull', color: '#10b981' },
        { num: 14, file: 'reset.html', label: 'Git Reset --hard', color: '#ef4444' },
        { num: 15, file: 'reset_soft.html', label: 'Git Reset --soft', color: '#f59e0b' },
        { num: 16, file: 'squash.html', label: 'Git Squash', color: '#a855f7' },
        { num: 17, file: 'cherry_pick.html', label: 'Git Cherry-Pick', color: '#06b6d4' },
        { num: 18, file: 'merge_in_branch.html', label: 'Git Merge', color: '#8b5cf6' },
        { num: 19, file: 'rebase.html', label: 'Git Rebase', color: '#ec4899' },
        { num: 20, file: 'stash.html', label: 'Git Stash', color: '#f59e0b' },
        { num: 21, file: 'blame.html', label: 'Git Blame', color: '#6366f1' },
    ];
