(function () {
    ...
    const PAGES = [
        { num: 1, file: 'what_is_git.html', label: 'What is Git?', color: '#8b5cf6' },
        { num: 2, file: 'what_is_commit.html', label: 'What is a Commit?', color: '#3b82f6' },
        { num: 3, file: 'commit_history.html', label: 'Commit History', color: '#60a5fa' },
        { num: 4, file: 'multi_file_commit.html', label: 'Multi-File Commits', color: '#10b981' },
        { num: 5, file: 'clone.html', label: 'Git Clone', color: '#f59e0b' },
        { num: 6, file: 'edit_commit.html', label: 'Git Add & Commit', color: '#60a5fa' },
        { num: 7, file: 'push.html', label: 'Git Push', color: '#10b981' },
        { num: 8, file: 'git_pull_main.html', label: 'Git Pull Fast-Forward', color: '#f59e0b' },
        { num: 9, file: 'pull.html', label: 'Git Pull (Merge)', color: '#f59e0b' },
        { num: 10, file: 'merge_conflict.html', label: 'Merge Conflict', color: '#ef4444' },
        { num: 11, file: 'branch.html', label: 'Branch & Commits', color: '#a855f7' },
        { num: 12, file: 'push_branch.html', label: 'Git Push Branch', color: '#10b981' },
        { num: 13, file: 'merge_request.html', label: 'Merge Request', color: '#3b82f6' },
        { num: 14, file: 'checkout_main_pull_origin_main.html', label: 'Git Checkout & Pull', color: '#10b981' },
        { num: 15, file: 'reset.html', label: 'Git Reset --hard', color: '#ef4444' },
        { num: 16, file: 'reset_soft.html', label: 'Git Reset --soft', color: '#f59e0b' },
        { num: 17, file: 'squash.html', label: 'Git Squash', color: '#a855f7' },
        { num: 18, file: 'cherry_pick.html', label: 'Git Cherry-Pick', color: '#06b6d4' },
        { num: 19, file: 'merge_in_branch.html', label: 'Git Merge', color: '#8b5cf6' },
        { num: 20, file: 'rebase.html', label: 'Git Rebase', color: '#ec4899' },
        { num: 21, file: 'stash.html', label: 'Git Stash', color: '#f59e0b' },
        { num: 22, file: 'blame.html', label: 'Git Blame', color: '#6366f1' },
    ];
