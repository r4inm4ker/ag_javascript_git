(function () {
    ...
    const PAGES = [
        ...
        { num: 5,  file: 'branch.html',         label: 'Branch & Commits',       color: '#a855f7' },
        { num: 6,  file: 'push_branch.html',    label: 'Git Push Branch',        color: '#10b981' },
        { num: 7,  file: 'merge_request.html',  label: 'Merge Requests',         color: '#3b82f6' },
        { num: 8,  file: 'pull.html',           label: 'Git Pull',               color: '#f59e0b' },
